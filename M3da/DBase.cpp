...
void DBase::AdvancingTet(cLinkedList* fEls, cLinkedList* fNodes, double dG) {
	...
	} while ((iTT < 5000) && (bExit == FALSE)); //(fEls->iNo>0);
			...
			if (line == "LINE") {
				while (getline(file, line)) {
					if (line == "  8")
						...
						NLine* pLN = AddLN(Pt1, Pt2, -1, FALSE);
						pLN->iFile = iL;
						break;
					}
				}
			} else if (line == "TEXT") // Text is assumed to be in XY plane
			{
				...
				while (getline(file, line)) {
					if (line == "  8")
						...
						CString sText;
						sText.Format(_T("%s"), text.c_str());
						vDir.x = cos(dAng * D2R);
						vDir.y = sin(dAng * D2R);
						vDir.z = 0;
						Text* pT = AddText(vN, vDir, Pt1, sText, height);
						pT->iFile = iL;
						break;
					}
				}
				...
				while (getline(file, line)) {
					if (line == "  8")
						...
						NCircle* pCir = AddCirCR(vN, Pt1, radius, -1);
						pCir->iFile = iL;
						break;
					}
				}
...
void DBase::ExportDXF(FILE* pFile2) {
	...
	fprintf(pFile2, "  2\n");
	fprintf(pFile2, "HEADER\n");
	fprintf(pFile2, "  9\n");
	fprintf(pFile2, "$CREATOR\n");
	fprintf(pFile2, "  1\n");
	fprintf(pFile2, "M3D_FEA\n");
	fprintf(pFile2, "  0\n");
	fprintf(pFile2, "ENDSEC\n");
	fprintf(pFile2, "  0\n");

	// Writing TABLES and LAYERS Sections
	fprintf(pFile2, "SECTION\n");
	fprintf(pFile2, "  2\n");
	fprintf(pFile2, "TABLES\n");
	fprintf(pFile2, "  0\n");
	fprintf(pFile2, "TABLE\n");
	fprintf(pFile2, "  2\n");
	fprintf(pFile2, "LAYER\n");
	fprintf(pFile2, "  0\n");
	fprintf(pFile2, "LAYER\n");
	fprintf(pFile2, "  2\n");
	fprintf(pFile2, "All\n");
	...
	fprintf(pFile2, "0\n");
	fprintf(pFile2, "  0\n");
	fprintf(pFile2, "ENDTAB\n");
	fprintf(pFile2, "  0\n");
	fprintf(pFile2, "ENDSEC\n");
	fprintf(pFile2, "  0\n");

	// Writing ENTITIES Section
	fprintf(pFile2, "SECTION\n");
	fprintf(pFile2, "  2\n");
